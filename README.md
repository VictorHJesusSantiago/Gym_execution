...
| RF08 | Configure **local preferences**: camera quality, feedback sound, dark mode |
...
| RNF03 | **Security** | JWT in secure storage (`expo-secure-store`), password hashing, rate limiting on auth, admin endpoints behind `X-Admin-Api-Key` |
